...
<head>
    ...
    <title>Register — Clubhouse</title>
...
<div class="card">
    <div style="margin-bottom:28px">
        ...
        <h2 style="font-family:'Syne',sans-serif;font-weight:700;font-size:1.4rem;color:white;margin:0">Create account</h2>
        <p style="color:#6b6b6b;font-size:0.8rem;margin-top:4px">Join Clubhouse</p>
    </div>

    @if($errors->any())
        <div class="err">@foreach($errors->all() as $e)<p>{{ $e }}</p>@endforeach</div>
    @endif
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div style="margin-bottom:14px">
            ...
            <input type="text" name="name" value="{{ old('name') }}" class="input" placeholder="Jane Smith" required autofocus>
        </div>
        <div style="margin-bottom:14px">
    ...
    <p style="text-align:center;margin-top:20px;font-size:0.8rem;color:#6b6b6b">
        Already have an account? <a href="{{ route('login') }}" style="color:#e8ff47;text-decoration:none">Sign in</a>
    </p>
</div>
</body>
</html>